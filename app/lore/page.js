    ...
    <div>
      <div>
        ...
        <div>
          ...
          <h2>Why Pluto?</h2>
          <p>
            Pluto is the farthest planet from the sun, making it a logical base
          ...
          <p>
            ...
            while thousands of passengers will sleep in pods. During this time,
            the passengers will live in a virtual world via a "full dive VR
            set." The crew can communicate with the passengers using the VR set,
            and passengers can control humanoid robots to interact with the
            physical world. Until they reach Pluto, passengers will continue
            working and perhaps laying the foundations of the new civilization
            in the virtual world. The spacecraft will also carry multipurpose
          ...
          <p>
            ...
            extreme temperatures, pressure, acidity levels, and radiation,
            allowing cells to use various gases for energy instead of oxygen.
            The energy generated also meets human energy needs and charges
            biotech items. Evolved cells change color, with the skin turning
            turquoise, becoming the most distinctive feature. Evolution cures
            cellular diseases like cancer and greatly prevents new diseases.
          </p>
          <p>
          ...
          <p>
            ...
            surpassing humans in size and strength, and enhanced with additional
            technologies for various purposes.
          </p>
          <p>
            <b>Full Dive VR Set:</b>Allows people to use their bodily signals in
            a virtual world.
          </p>
          ...
          <p>
            ...
            and vegetables with added multivitamins/minerals. Since these foods
            have no fiber, there will be no need for excretion (they will get
            used to this while still on Earth).
            <br />
            ...
            genetically passed on, meaning children born will also be suited for
            living in space.
            <br />
            The foundations of buildings will use devices that apply centrifugal
            force downward to increase or decrease weight. This will cause
            buildings to float before an earthquake and stick to the ground
            otherwise.
            <br />
          ...
          <ul>
            <li>
              ...
              <p>
                ...
                the new decentralized space civilization, using advanced
            ...
            <li>
              ...
              <p>
                ...
                environmental science. They will prioritize providing advanced
                technology for the civilizations’ needs without political
                constraints.{" "}
              </p>
              <span>
                <Image
            ...
            <li>
              ...
              <p>
                ...
                questions. Their main mission is to cultivate wisdom and promote
                critical thinking in future generations by taking on the
            ...
            <li>
              ...
              <p>
                ...
                artistic expression. From painting to sculpture, music to
                literature, they embrace all forms of art and use their talents
            ...
            <li>
              ...
              <p>
                ...
                explorations, managing resources, and establishing contact with
                other civilizations. Their work requires close coordination with
                the other factions.
              </p>
              <span>
                <Image
          ...
          <div>
            <h3>Chapters</h3>
            <h5>Chapter 1: Selection and Training</h5>
            <p>
            ...
            living and working together in a confined space for an extended
            period of time.
            <h5>Chapter 3: Establishing a Sustainable Society</h5>
            <p>
            ...
            <h5>Chapter 4: Exploration and Expansion</h5>
            <p>
            ...
            <h5>Chapter 5: Ensuring the Future of the New Civilization </h5>
            <p>
